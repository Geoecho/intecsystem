...
const Hero232 = ({ className }: Hero232Props) => {
  return (
    <section
      className={cn(
        "relative h-screen w-full bg-background py-16 md:py-32 flex items-center justify-start md:justify-center px-6 md:px-0",
        className,
      )}
    >
      <div className="relative z-20 container flex items-start md:items-center justify-start md:justify-center">
        <div className="flex w-full md:w-fit flex-col items-start md:items-center justify-start md:justify-center gap-4 pb-3 text-left md:text-center">
          <Button
            variant="ghost"
            className="text-md mt-12 md:mt-24 flex h-10 w-fit items-center justify-center gap-3 rounded-md px-6 tracking-tight hover:bg-transparent cursor-default"
          >
            <span className="size-2 rounded-full bg-primary" />
            <span>Industrial Technology & Systems</span>
          </Button>
          <div className="relative flex max-w-4xl items-center justify-start md:justify-center text-left md:text-center text-4xl font-medium tracking-tight sm:text-4xl md:text-7xl">
            <h1 className="relative z-10 tracking-tighter">
              ...
              <span className="text-muted-foreground/50"> through Systems</span>
              <span>.</span>
            </h1>
          </div>
      ...
      <Illustration1
        ...
        className="absolute top-6 left-0 hidden text-primary/10 lg:block dark:text-primary/40"
      />
      ...
      <Illustration1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, ease: [0, 0, 0, 1.12] }}
        className="absolute top-32 right-0 hidden scale-x-[-1] scale-y-[-1] text-primary/10 lg:block dark:text-primary/40"
      />
    </section>
  );
};
...
const Illustration1 = (props: React.ComponentProps<typeof motion.svg>) => {
  return (
    <motion.svg
      {...props}
      width="571"
