...
const Navbar33 = ({
  ...
  return (
    <header
      className={cn(
        "fixed left-1/2 z-50 w-[min(95%,1100px)] -translate-x-1/2 rounded-4xl border bg-background transition-all duration-300",
        "top-5 lg:top-10",
        className,
      )}
    >
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-2.5">
          <a href="/contact" className="max-lg:hidden">
            <Button variant="default" className="h-10 rounded-full px-6 py-1 tracking-tight">
